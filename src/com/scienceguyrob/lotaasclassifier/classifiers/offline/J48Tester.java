...
/**
 * The class J48Tester tests the J48 implementation of a decision tree from Weka.
 *
 * @author Rob Lyon
 *
 * @version 1.0, 05/03/13
 */
public class J48Tester extends WekaClassifier implements I_WekaTest
{
    /**
     *
     *	VARIABLES
     ...
     */
    public J48Tester(BasicLogger l, String n){ super(l,n); }
     ...
     * @param n the name of the class.
     */
    public J48Tester(String n){ super(n);}
    ...
    public J48 getClassifier(){ return this.learner; }
